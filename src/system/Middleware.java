...
public class Middleware {
	 ...
	 * @param target_ip Arduino IP address.
	 * @param target_port Arduino target port.
	 * @param source_pull_port Source pull port.
	 * @param source_push_port Source push port.
	 */
	 ...
	 * @param protocol Network protocol used.
	 * @param target_ip Arduino IP address.
	 * @param target_port Arduino IP port.
	 */
	...
	/**
	 * Returns reference to sensor object.
	...
	/**
	 * Returns reference to actuator object.
	 * @param device_name Name of device.
	 * @return reference to actuator.
	 */
